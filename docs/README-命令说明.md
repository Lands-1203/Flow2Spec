...
入参可选（说明文字或文档路径；无参=扫描代码须先确认）。输出默认 **`stock-docs/<项目名>架构说明_初稿.md`**。可接 **f2s-doc-final** → **f2s-ctx-build**。
...
上下文：f2s-doc-arch → f2s-doc-final → f2s-ctx-build → main + Rules + Skills + docs-index
...
| 上下文生成 | 初稿 / 终稿 / 生成上下文 | **f2s-doc-arch** / **f2s-doc-final** / **f2s-ctx-build** |
|            | 删某文档上下文           | **f2s-ctx-rm**                                           |
