---
name: gen-architecture-doc
description: 根据用户说明或文档（或扫描代码）生成项目架构说明初稿，无固定格式，描述清楚即可；触发：项目架构说明、genStructureDoc、架构初稿
---
...
- 生成初稿后，可提示用户：可根据需要修改 `配置根/stock-docs/xxx架构说明_初稿.md`，若需转为《终稿模版》规范格式，可再按 **spec2context-md** 技能、以 `配置根/stock-docs/xxx架构说明_初稿.md` 为入参得到终稿（`_终稿.md`），再按 **generate-project-context** 技能生成 Rules、Skills。
