...
- 生成初稿后，可提示用户：可根据需要修改 `配置根/stock-docs/xxx架构说明_初稿.md`，若需转为《终稿模版》规范格式，可再执行 **`/spec2context-md 配置根/stock-docs/xxx架构说明_初稿.md`** 得到终稿（`_终稿.md`），并配合 `/generateProjectContext` 生成 Rules、Skills。
