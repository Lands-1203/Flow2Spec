...
- 本主题用于说明 **本仓库内** Flow2Spec **对外介绍用 HTML 演示稿** 的位置、打开方式与维护约定。
- **禁止**将演示稿正文当作 `req-docs` 去驱动业务代码实现；演示材料归属 `stock-docs` 索源说明（见下「关联文档」）。
...
- 索源与路径表：[对外介绍演示](../stock-docs/Flow2Spec-对外介绍演示.md)
